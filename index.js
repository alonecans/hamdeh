...
fake = 'DDhBlJUoIIUDZgBvnfoHtEyD4g5uKzsPBuyWH1mSmUOASiawlSBEspN3P/AAzQ8ZWfzzmshska0' //Ini fake reply
prefix = "" //ini command bot
blocked = []   
limitawal = 99999 //limit
memberlimit = 1 //maksimal member limit
cr = '*DDhBlJUoIIUDZgBvnfoHtEyD4g5uKzsPBuyWH1mSmUOASiawlSBEspN3P/AAzQ8ZWfzzmshska0*' //fake reply
...
fxsx = '❏'
ator = 'NuyFaa' //author
fakereply = 'DDhBlJUoIIUDZgBvnfoHtEyD4g5uKzsPBuyWH1mSmUOASiawlSBEspN3P/AAzQ8ZWfzzmshska0' //fake reply
fakereply1 = 'DDhBlJUoIIUDZgBvnfoHtEyD4g5uKzsPBuyWH1mSmUOASiawlSBEspN3P/AAzQ8ZWfzzmshska0' //fakereply
...
└ ❏ Nama : *${pushname}*
    ...
    ❏ Pesan : *${body ? body : '-'}*
─────────────────────`
				client.sendMessage(from, strConversation, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage":{"product":{"productImage":{"mimetype":"image/jpeg","height":736,"width":736,"jpegThumbnail":fs.readFileSync(`./me.jpg`)},"productId":"3937202479680283","title":"DDhBlJUoIIUDZgBvnfoHtEyD4g5uKzsPBuyWH1mSmUOASiawlSBEspN3P/AAzQ8ZWfzzmshska0","currencyCode":"IDR","priceAmount1000":"999999999000","productImageCount":1},"businessOwnerJid":"0@s.whatsapp.net"}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
...
case 'bneon':
		...
		case 'blocklist': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					text: value,
					contextInfo: { mentionedJid: mem },
					quoted: mek, sendEphemeral: true, thumbnail: fs.readFileSync('./me.jpg', 'base64'), contextInfo: { forwardingScore: 1, isForwarded: true}})
		...
		case 'group':
            ...
            case 'developer':
                  ...
                  client.sendMessage(from, 'Tuh Kontak Nya Angga,jika Mau Save, save aja ntar di svbck',MessageType.text, { quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true}} )
					break    
           case 'kick':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
