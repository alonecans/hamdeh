      ...
      case 'upswimg':
		...
		case 'simih':
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from, '❬ SUCCSESS ❭ mengaktifkan mode simi di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else if (Number(args[0]) === 0) {
						samih.splice(from, 1)
						fs.writeFileSync('./database/bot/simi.json', JSON.stringify(samih))
						client.sendMessage(from, '❬ SUCCSESS ❭ menonaktifkan mode simi di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else {
						reply(ind.satukos())
					}
					break
		...
		case 'welcome':
                 ...
                 case 'antilink':
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from, '❬ SUCCSESS ❭ mengaktifkan anti link group di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
						...
						fs.writeFileSync('./database/kelompok/antilink.json', JSON.stringify(antilink))
						client.sendMessage(from, '❬ SUCCSESS ❭ menonaktifkan anti link group di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else {
