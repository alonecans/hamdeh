...
break
					...
					if (!isOwner) return reply(ind.ownerb())
					fxsx = args.join(" ")
					reply(`FxMenu berhasil di ubah menjadi : ${fxsx}`)
					break 
					case 'settobz':
					if (!isRegistered) return reply(ind.noregis())
					if (!isOwner) return reply(ind.ownerb())
